...
const teamRosters = {
  "Korea": ["꿀뚱", "잠뜰", "끼끼", "쉐이머스", "도티", "바토로", "돌돌", "토토", "판다", "쵸파", "꿀순"],
  "America": ["펭귄", "풀범", "꿀복", "꿀땡", "소소"],
  "Fantasy": ["꿀뚱", "잠뜰", "끼끼", "쉐이머스", "도티", "바토로", "돌돌", "토토", "판다", "쵸파", "꿀순", "펭귄", "풀범", "꿀복", "꿀땡", "소소"],
};
const teamPitchers = {
    "Korea": ["수달", "또또", "골드버그", "로만", "HHH", "파이리", "돌", "류현진", "지방"],
    "America": ["더락", "딘", "오스틴"],
    "Fantasy": ["수달", "또또", "골드버그", "로만", "HHH", "파이리", "돌", "류현진", "지방", "더락", "딘", "오스틴"],
}
    ...
    try{
        if(!fileHandle)
        {
            fileHandle = await window.showSaveFilePicker({
                suggestedName: 'fantasySimPlayer_stats.txt',
                types: [{
